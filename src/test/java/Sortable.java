...
public class Sortable {
    ...
    public void setUp() {
        ...
        ReportDetails reportDetails = new ReportDetails(property + "\\TestReport4",
    ...
    public void testOne() {
        ...
        builder.clickAndHold(Home.sortable1).perform();
        builder.moveToElement(Home.sortable6).perform();

        builder.release(Home.sortable1).perform();
